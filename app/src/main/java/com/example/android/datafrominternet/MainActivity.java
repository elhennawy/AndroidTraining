...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        // COMPLETE (4) Create a new GithubQueryTask and call its execute method, passing in the url
        // to query
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String>{
        ...
        protected String doInBackground(URL... urls) {
            URL urlobject=urls[0];
            String githubSearchResults="";

            try {
                Log.d(TAG, "Getting data from Github");
                githubSearchResults=NetworkUtils.getResponseFromHttpUrl(urlobject);
            } catch (IOException e) {
                e.printStackTrace();
            }
